...
def lambda_handler(event, context):
    print("Event: " + json.dumps(event['headers'], indent=4))
    ...
    verify_key_value = headers.get('x-verfiy-key')
    if verify_key_value == 'bababa':
    ...
    # Extract necessary information from the LambdaContext object
    context_data = {
    ...
    authResponse['context'] = context_data
